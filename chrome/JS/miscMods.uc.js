...
(function () {
    ...
    class UCMiscMods {
        ...
        anchorBookmarksTooltip() {
            BookmarksEventHandler.fillInBHTooltip = function (
                aDocument,
                aEvent
            ) {
                var node;
                ...
                let tooltipTitle = aEvent.target.querySelector(
                    ".places-tooltip-title"
                );
                tooltipTitle.hidden = !title || title == url;
                if (!tooltipTitle.hidden) tooltipTitle.textContent = title;
                let tooltipUrl = aEvent.target.querySelector(
                    ".places-tooltip-uri"
                );
        ...
        containerIconsOnMultiselectedTabs() {
            ...
            if (lazy.ContextualIdentityService.hasOwnProperty("setTabStyle"))
                return;
        ...
        randomTinyStuff() {
            ...
            let searchbarPopup = document.getElementById(
