                ...
                let CustomHint = {
                    ...
                    show(anchor, message, options = {}) {
                        ...
                        this._panel.addEventListener(
                            "popupshown",
                            () => {
                                this._animationBox.setAttribute(
                                    "animate",
                                    "true"
                                );
                                this._timerID = setTimeout(() => {
                                    this._panel.hidePopup(true);
                                    this._animationBox.removeAttribute(
                                        "hidden"
                                    );
                                }, DURATION + 120);
                            },
                    ...
                    _ensurePanel() {
                        if (!this.__panel) {
                            ...
                            let wrapper = aDoc.getElementById(
                                "confirmation-hint-wrapper"
                            );
                            wrapper?.replaceWith(wrapper.content);
                            this.__panel =
                                aDoc.getElementById("confirmation-hint");
                ...
                function toolboxObserver(sub, top, _data) {
                    ...
                    switch (top) {
                        ...
                        case "devtools-thread-ready":
                            ...
                            if (threadActor)
                                threadActor.destroy = destroyThreadActor;
                            break;
                        default:
                            break;
                    }
                        ...
                        if (val === 0) {
                            switch (key) {
                                ...
                                case "browserToolbox":
                                    ...
                                    hotkey =
                                        aDoc.defaultView.key_browserToolbox;
                                    break;
                                case "popupHide":
                                    labelString = l10n.getString(
