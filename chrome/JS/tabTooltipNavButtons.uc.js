...
class TabTooltipNav {
    static config = {
        ...
        l10n: {
            ...
            "Go Forward (Multiselected)":
                "Navigate selected tabs forward one page",
    ...
    get tabBackForwardMenu() {
        return (
            ...
            (this._tabBackForwardMenu = document.querySelector(
                "#tabBackForwardMenu"
            ))
        );
    }
    get tooltipBox() {
        return (
            this._tooltipBox ||
            (this._tooltipBox = this.navPopup.querySelector(
                "#tab-nav-tooltip-box"
            ))
        );
    }
    ...
    get forwardButton() {
        return (
            this._forwardButton ||
            (this._forwardButton =
                this.navPopup.querySelector("#tab-nav-forward"))
        );
    }
    get reloadButton() {
        return (
            this._reloadButton ||
            (this._reloadButton =
                this.navPopup.querySelector("#tab-nav-reload"))
        );
    }
    get favicon() {
        return (
            this._favicon ||
            (this._favicon = this.navPopup.querySelector(
    ...
    set knownWidth(val) {
        if (val) {
            this.navPopup.style.setProperty(
                "--tab-nav-known-width",
                val + "px"
            );
...
<menupopup
  ...
  oncommand="tabNavButtons.gotoHistoryIndex(event); event.stopPropagation();"/>`;
    ...
    onMouseleave() {
        ...
        if (this.menuOpen) return;
        if (
            this.navPopup.matches(":hover") ||
            this.triggerTab?.matches(":hover")
        )
            return;
    ...
    fillHistoryMenu(menupopup) {
        ...
        if (
            ...
            menupopup.addEventListener("DOMMenuItemActive", (e) => {
                if (e.target.hasAttribute("checked")) {
                    ...
                    let title = this.navPopup.querySelector(
                        ".places-tooltip-title"
                    );
                    let urlLabel = this.navPopup.querySelector(
                        ".places-tooltip-uri"
                    );
                    let { favicon } = this;
        ...
        const tooltipForward = gNavigatorBundle.getString(
