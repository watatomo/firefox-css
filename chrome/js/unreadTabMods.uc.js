...
(function () {
    ...
    class UnreadTabsBase {
        ...
        constructor() {
            if (
                gBrowser.tabContainer._handleTabSelect.name !==
                "uc_handleTabSelect"
            ) {
                eval(
            ...
            if (
                gBrowser.tabContainer._handleNewTab.name !== "uc_handleNewTab"
            ) {
                eval(
        ...
        handleEvent(e) {
            ...
            this.markAsReadMenuitem.setAttribute(
                "label",
                unreadTabs.length > 1
                    ? UnreadTabsBase.config[
                          "Mark Multiple Tabs as Read Label"
                      ].replace("#1", unreadTabs.length.toLocaleString())
            ...
            this.markAsUnreadMenuitem.setAttribute(
                ...
                readTabs.length > 1
                    ? UnreadTabsBase.config[
                          "Mark Multiple Tabs as Unread Label"
                      ].replace("#1", readTabs.length.toLocaleString())
