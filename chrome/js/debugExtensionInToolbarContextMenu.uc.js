...
class DebugExtension {
    ...
    constructor() {
        ...
        this.pageActionContext = document.getElementById(
        ...
        this.unifiedExtensionsMenupopup =
            this.unifiedExtensionsMenu.appendChild(
                document.createXULElement("menupopup")
            );
    ...
    getMenuDetails(popup) {
        ...
        if (this.pageActionContext.contains(popup)) {
            ...
            getExtensionId = () => {
                return BrowserPageActions.actionForNode(popup.triggerNode)
                    .extensionID;
            };
    ...
    makeMenu(type, popup) {
        ...
        let menupopup = menu.appendChild(
            document.createXULElement("menupopup")
        );
        ...
        switch (type) {
            ...
            case "CopyURL":
                ...
                if (
                    ...
                    if (
                        actionNode.className.includes("unified-extensions-item")
                    ) {
