    ...
    useEffect(() => {
        let unsubscribe = handle.subscribe(() => {
            ...
            if (handle.writing) {
                ...
                setUpdateBarLabel(
                    `Update to ${remoteScriptData.version} available`
                );
    ...
    return (
        ...
        >
            ...
            {expanded ? (
                <ScriptDetails
                    script={script}
                    launchLocalFile={launchLocalFile}
                />
            ) : null}
        </div>
    );
...
export const ScriptDetails = ({ script, launchLocalFile }) => {
    ...
    const [descriptionToggleHidden, setDescriptionToggleHidden] =
        useState(true);
        ...
        <div className="script-card-expanded">
            <div className="script-detail-rows">
                ...
                <div className="script-detail-row script-detail-type">
                    ...
                    {script.isESM
                        ? "ES module"
                        : (script.inbackground && "Background script") ||
                          "Chrome script"}
                </div>
                <div
