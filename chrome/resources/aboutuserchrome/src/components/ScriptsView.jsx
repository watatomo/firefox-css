...
export const ScriptsView = () => {
    ...
    const [updateAllButtonDisabled, setUpdateAllButtonDisabled] =
        useState(false);
            ...
            <div id="scripts-header" className="view-header">
                <div className="sticky-container">
                    ...
                    <WarningBox
                        ...
                        noResultsForSearch={
                            filteredScripts.length < 1 && search
                        }
                        searchUnit="scripts"
                    />
                </div>
