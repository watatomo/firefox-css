// ==UserScript==
// @name           Restore Translation Notification Panel Arrows
// @version        1.0
// @author         aminomancer
...
class MozTranslationNotification extends MozElements.Notification {
    ...
    optionsShowing() {
        ...
        let langName = Services.intl.getLanguageDisplayNames(undefined, [
            lang
        ])[0];
